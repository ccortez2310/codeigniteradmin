                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="address" name="address" rows="3"
                                  class="form-control form-control-sm <?= $validation->getError('address') ? 'is-invalid' : '' ?>"><?= old('address', $company['address']) ?></textarea>
                        <?php
                    ...
                    <div class="form-group">
                        ...
                        <input id="business_line" type="text" name="business_line"
                               ...
                               value="<?= old('business_line', $company['business_line']) ?>"
                        >
                        <?php
                    ...
                    <div class="form-group">
                        ...
                        <input id="legal_representative" type="text" name="legal_representative"
                               ...
                               value="<?= old('legal_representative', $company['legal_representative']) ?>"
                        >
                        <?php
